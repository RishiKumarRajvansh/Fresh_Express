    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('store_owner', 'Store Owner'), ('store_staff', 'Store Staff'), ('delivery_agent', 'Delivery Agent'), ('admin', 'Admin')], default='customer', max_length=20)),
